...
> ˼🤖˹↜ الــبــوت↶
╮───────────────────⟢ـ
┆⚙️ ↜اسـم الـبـوت↶﹝𝙰𝙺𝙰𝚂𝙷𝙸﹞
┆🪄 ↜الـمـطـور ↶﹝MO👑🇪🇬﹞
┆📌 ↜الـتـشـغـيـل ↶﹝${uptime}﹞
┆🔖 ↜الــمــســتـخـدمـيـن ↶﹝${rtotalreg}﹞
╯───────────────────⟢ـ
> © MO 2025`,subtitle: "Araab Zack",},header: { hasMediaAttachment: true,...(await prepareWAMessageMedia({ image : { url: zack } }, { upload: conn.waUploadToServer }, {quoted: m}))},
                    contextInfo: {
                        ...
                        isForwarded: false,
...

                            {
                                ...
                                buttonParamsJson: JSON.stringify({
                                    ...
                                    sections: [
                                        {
                                            title: 'مــرحـ🛡ـبــا بــك فـي مــ☑هــام اكاشي بـ🤖ـوت',
                  ...
                  messageParamsJson: ''
                     ...
                     {
               name: "cta_url",
               buttonParamsJson: '{"display_text":"⌈📲╎قـنـاة الــبــوت╎📲⌋","url":"https://whatsapp.com/channel/0029Vb38QGWIN9isnQ2egu3n","merchant_url":"https://chat.whatsapp.com/JiYftu4x1U3Jlt1Nj639La"}'
                            }
                        ]
                    }
                }
